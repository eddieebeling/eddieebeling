import { hasInjectionContext, getCurrentInstance, inject, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, ref, Suspense, Fragment, createApp, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, getCurrentScope, useSSRContext } from 'vue';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BrxYv8An.mjs')
  },
  {
    name: "thank-you",
    path: "/thank-you",
    component: () => import('./thank-you-DEsjaMDX.mjs')
  }
];
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<figure class="portrait"><img class="portrait__img"${ssrRenderAttr("src", photoUrl.value)}${ssrRenderAttr("alt", `${name.value} ${title.value}`)}><figcaption class="sr-only">${ssrInterpolate(name.value)} is a ${ssrInterpolate(bio.value)}</figcaption></figure></main>`);
    };
  }
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BYIP2Aa7.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Ce3igrP2.mjs'));
